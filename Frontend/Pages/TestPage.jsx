...
const TestPage = () => {
    ...
    return (
        <div className='bg-[#18181b] h-[100dvh] flex flex-col selection:bg-[#535151]'>
            ...
            <div className='flex flex-1 overflow-hidden relative'>
                {/* courseList */}
                <div className={` md:w-[19%] w-full h-full flex absolute top-0 left-0 ${showCourseList ? 'z-1' : 'z-0'} md:relative`}>
                    <div className={`${showCourseList ? 'block' : 'hidden'} md:block w-[80%] md:w-[100%] h-full bg-[#18181b] flex flex-col justify-between border-r border-[#535151] border-neutral-200 dark:border-neutral-800 px-2`}>
                        <div className='h-full w-full'>
                            <button class=" w-full rounded-md  flex flex-1 items-center justify-between gap-2 px-2 py-1.5 transition-colors focus-visible:outline-neutral-700 dark:focus-visible:outline-brand" type="button" id="radix-:R2b7l9uuffkva:" aria-haspopup="menu" aria-expanded="false" data-state="closed">
                        ...
                        {/* Profile */}
                        <div className='h-[50px] flex items-center p-4 border-t border-[#535151] dark:border-neutral-800'>
                    ...
                    <div className=''>
                        <button onClick={() => setShowCourseList(!showCourseList)} className='bg-[#27272a] ml-2 mt-2 rounded-full hover:bg-[#3f3f46] cursor-pointer flex md:hidden items-center justify-center  w-[40px] h-[40px]'>
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" className="shrink-0 !size-4 text-white" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
